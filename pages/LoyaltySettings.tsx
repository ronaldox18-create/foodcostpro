            ...
            fallback={
                <div className="h-screen flex items-center justify-center bg-gray-50 flex-col gap-4">
                    ...
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-gray-900">Recurso Premium</h2>
                        <p className="text-gray-500 mt-2 max-w-md mx-auto">
                            O Programa de Fidelidade está disponível apenas nos planos Starter e Pro.
                            Faça um upgrade para fidelizar seus clientes!
                        </p>
                        <button
                            onClick={() => navigate('/account?tab=plan')}
                            className="mt-6 px-6 py-2 bg-orange-600 text-white rounded-lg font-bold hover:bg-orange-700 transition"
                        >
                            Fazer Upgrade
                        </button>
                    </div>
